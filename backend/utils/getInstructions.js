...
export const generateGeminiInstruction = async (score) => {
  ...
  const prompt = `
    ...
    Please write friendly, helpful improvement tips(points wise) using clear Markdown formatting. Follow these rules:
    - Keep the entire response under 250 words.
    - Start with a short summary of the user’s performance.
    - Give exactly 3 practical tips to improve IQ and cognitive sk ills.
